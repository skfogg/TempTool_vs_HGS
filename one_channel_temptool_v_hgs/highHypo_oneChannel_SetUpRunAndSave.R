...
runDescription <- "One Outflow Channel, NO ATM, Iskulpaa Input, High Hypo Exchange"
#
...
save(oneChannel, file = "C:/Users/skati/Documents/TempTool_vs_HGS/temptool_output/highHypo_OneChannel.RData")
