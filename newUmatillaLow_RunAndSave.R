...
umatillaBins_Low <- hyporheicBins(18, 2, 60, 182*86400, 0.25, 12.5, b=-1.39)
...
###
##
runid <- "new umatilla aquifer size, low scenario 3.125m water storage"
...
newUmatillaLow<- outList

save(newUmatillaLow, file = "C:/Users/t24x137/Desktop/TempTool_2020/newUmatillaLow.RData")
