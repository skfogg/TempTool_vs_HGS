...
firstBin <- 1
lastBin <- 18
whichaquifer <- umatillaBins_1third
...
runid <- "umatilla 1/3rd: i.e. low scenario"
...
umatilla1third <- outList

save(umatilla1third, file = "C:/Users/t24x137/Desktop/TempTool_2020/umatilla1Third.RData")
